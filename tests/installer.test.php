...
file_put_contents($tmpRoot . '/assets/js/referral-rewards.js', "var DEFAULT_BOT_USERNAME = 'TONBridge_robot';\nvar DEFAULT_WORKER_BASE_URL = 'https://bridge-worker.tonbankcard.workers.dev';\n");
...
sort($changed);
assert_true($changed === ['0.html', 'admin/index.html', 'app-settings.html', 'assets/js/base.js', 'assets/js/deep-link.js', 'assets/js/referral-rewards.js', 'assets/js/social-proof.js', 'dist/admin/index.html', 'index.html'], 'static replacement should report changed deploy files');
...
assert_contains("DEFAULT_BOT_USERNAME = 'ExampleBridgeBot'", file_get_contents($tmpRoot . '/assets/js/referral-rewards.js'), 'referral rewards JS should get installer bot username');
assert_contains("DEFAULT_WORKER_BASE_URL = 'https://worker.example.com'", file_get_contents($tmpRoot . '/assets/js/referral-rewards.js'), 'referral rewards JS should get installer worker URL');
